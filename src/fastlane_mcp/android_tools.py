...
def list_supported_actions() -> dict[str, Any]:
    ...
    actions = [
        SupportedAction(tool_name="healthcheck", category="diagnostics", description="Check local tool availability.", underlying_capability="python --version, ruby --version, bundle --version, fastlane --version"),
        SupportedAction(tool_name="doctor", category="diagnostics", description="Validate project config and prerequisites.", underlying_capability="Local filesystem and PATH checks"),
        SupportedAction(tool_name="list_supported_actions", category="diagnostics", description="List available MCP tools.", underlying_capability="Static metadata"),
        SupportedAction(tool_name="store_listing_requirements", category="diagnostics", description="Return current Play Store and App Store listing requirements.", underlying_capability="Static metadata from official Apple and Google docs"),
        SupportedAction(tool_name="android_build_aab", category="build", description="Build an Android App Bundle.", underlying_capability="Gradle bundle task"),
        SupportedAction(tool_name="android_build_apk", category="build", description="Build an Android APK.", underlying_capability="Gradle assemble task"),
        SupportedAction(tool_name="android_upload_to_internal", category="release", description="Upload a build to the internal track.", underlying_capability="fastlane upload_to_play_store"),
        SupportedAction(tool_name="android_upload_to_beta", category="release", description="Upload a build to the beta track.", underlying_capability="fastlane upload_to_play_store"),
        SupportedAction(tool_name="android_upload_to_production", category="release", description="Upload a build to the production track.", underlying_capability="fastlane upload_to_play_store"),
        SupportedAction(tool_name="android_promote_track", category="release", description="Promote an existing release between tracks.", underlying_capability="fastlane upload_to_play_store track_promote_to"),
        SupportedAction(tool_name="android_validate_play_auth", category="release", description="Validate Play JSON key and app access.", underlying_capability="fastlane validate_play_store_json_key + google_play_track_version_codes"),
        SupportedAction(tool_name="android_upload_metadata", category="metadata", description="Upload store listing text metadata.", underlying_capability="fastlane upload_to_play_store"),
        SupportedAction(tool_name="android_upload_images", category="metadata", description="Upload icons and screenshots.", underlying_capability="fastlane upload_to_play_store"),
        SupportedAction(tool_name="android_upload_changelogs", category="metadata", description="Upload changelog files.", underlying_capability="fastlane upload_to_play_store"),
        SupportedAction(tool_name="android_upload_everything", category="metadata", description="Upload binary plus metadata assets.", underlying_capability="fastlane upload_to_play_store"),
        SupportedAction(tool_name="android_get_latest_build_info", category="introspection", description="Read latest release info for a track.", underlying_capability="fastlane google_play_track_version_codes + google_play_track_release_names"),
        SupportedAction(tool_name="android_show_effective_config", category="introspection", description="Show merged config with secrets redacted.", underlying_capability="Config loader"),
        SupportedAction(tool_name="ios_upload_to_testflight", category="release", description="Upload an iOS build to TestFlight.", underlying_capability="fastlane upload_to_testflight"),
        SupportedAction(tool_name="ios_distribute_testflight_build", category="release", description="Distribute an existing TestFlight build to tester groups.", underlying_capability="fastlane upload_to_testflight distribute_only"),
        SupportedAction(tool_name="ios_manage_testflight_testers", category="release", description="Manage TestFlight testers and groups.", underlying_capability="fastlane pilot"),
        SupportedAction(tool_name="ios_upload_to_app_store", category="release", description="Upload an iOS build plus App Store assets.", underlying_capability="fastlane upload_to_app_store"),
        SupportedAction(tool_name="ios_create_app", category="release", description="Create a new app in App Store Connect.", underlying_capability="fastlane produce"),
        SupportedAction(tool_name="ios_upload_metadata", category="metadata", description="Upload App Store text metadata.", underlying_capability="fastlane upload_to_app_store"),
        SupportedAction(tool_name="ios_upload_screenshots", category="metadata", description="Upload App Store screenshots.", underlying_capability="fastlane upload_to_app_store"),
        SupportedAction(tool_name="ios_upload_app_privacy_details", category="metadata", description="Upload App Privacy Details.", underlying_capability="fastlane upload_app_privacy_details_to_app_store"),
        SupportedAction(tool_name="ios_precheck", category="metadata", description="Validate App Store metadata before submission.", underlying_capability="fastlane precheck"),
        SupportedAction(tool_name="ios_get_latest_build_info", category="introspection", description="Read latest TestFlight and App Store build numbers.", underlying_capability="fastlane latest_testflight_build_number + app_store_build_number"),
        SupportedAction(tool_name="ios_show_effective_config", category="introspection", description="Show merged config with Apple and Play secrets redacted.", underlying_capability="Config loader"),
        SupportedAction(tool_name="ios_sync_code_signing", category="signing", description="Sync certificates and profiles with match.", underlying_capability="fastlane match"),
    ]
    return _base_success(
